...
`window` is the **global object** in the browser. It represents the **browser window/tab itself** and everything running inside it. It is **not part of core JS**. It’s part of the _browser environment_.
## `Explanation`
